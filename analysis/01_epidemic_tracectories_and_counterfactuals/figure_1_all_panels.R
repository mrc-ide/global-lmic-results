...
base_path <- here::here()
file_path <- "/analysis/data/raw_data/server_results/archive/brt_google_mobility/20200602-002850-6baa471e/google_brt.rds"
mobility <- readRDS(paste0(base_path, file_path))
