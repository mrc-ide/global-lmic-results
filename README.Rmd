...
[![Travis-CI Build Status](https://travis-ci.org/mrc-ide/global-limc-results.png?branch=master)](https://travis-ci.org/mrc-ide/global-limc-results) 
...
cd global-lmic-results
open globalmicresults.Rproj
